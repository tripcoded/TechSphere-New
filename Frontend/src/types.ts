...
// Placeholder exports for production (must provide real authentication)
export const DUMMY_MEMBER_CREDENTIALS = { email: "", password: "" };
export const DUMMY_ADMIN_CREDENTIALS = { apiKey: "" };
